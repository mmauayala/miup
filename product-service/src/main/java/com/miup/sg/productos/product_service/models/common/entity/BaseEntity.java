package com.miup.sg.productos.product_service.models.common.entity;
...
import com.miup.sg.productos.product_service.models.auth.enums.TokenClaims;
...
public class BaseEntity {
    ...
    public void prePersist() {
        this.createdBy = Optional.ofNullable(SecurityContextHolder.getContext().getAuthentication())
                ...
                .map(Jwt.class::cast)
                .map(jwt -> jwt.getClaim(TokenClaims.USER_USERNAME.getValue()).toString())
